...
function _ServicesSection(props: ServicesSectionProps) {
  return (
    <section id="services" className="py-20 bg-white">
        <div className="container mx-auto px-6">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
                ...
                <img src="/happy.png" alt="All Product" className="w-14 h-14 object-contain mr-4" />
                <div>
                ...
                {/* Service 2 */}
                <div className="service-card bg-white p-8 rounded-lg shadow-md transition duration-300 flex items-start gap-4 hover:shadow-lg">
                <img src="/refund.png" alt="Refund" className="w-14 h-14 object-contain mr-4" />
                <div>
                ...
                {/* Service 3 */}
                <div className="service-card bg-white p-8 rounded-lg shadow-md transition duration-300 flex items-start gap-4 hover:shadow-lg">
                <img src="/noidia.png" alt="VAT" className="w-14 h-14 object-contain mr-4" />
                <div>
                ...
                {/* Service 4 */}
                <div className="service-card bg-white p-8 rounded-lg shadow-md transition duration-300 flex items-start gap-4 hover:shadow-lg">
                <img src="/bank.png" alt="Unlimited" className="w-14 h-14 object-contain mr-4" />
                <div>
                ...
                {/* Service 5 */}
                <div className="service-card bg-white p-8 rounded-lg shadow-md transition duration-300 flex items-start gap-4 hover:shadow-lg">
                <img src="/shied.png" alt="Security" className="w-14 h-14 object-contain mr-4" />
                <div>
                ...
                {/* Service 6 */}
                <div className="service-card bg-white p-8 rounded-lg shadow-md transition duration-300 flex items-start gap-4 hover:shadow-lg">
                <img src="/contract.png" alt="Contract" className="w-14 h-14 object-contain mr-4" />
                <div>
                ...
                *Always reserve a stable number of &gt;1000 accounts with spending history ( Accept BH, WH, GH : Gambling, Crypto, App,
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="flex flex-col gap-4 h-full">
                        <img src="/camp1.jpg" alt="Facebook Ads Campaign Screenshot" className="h-1/2 object-cover rounded-xl shadow-lg border border-gray-200 w-full" />
                        <img src="/camp3.jpg" alt="Extra Image" className="h-1/2 object-cover rounded-xl shadow-lg border border-gray-200 w-full" />
                    </div>
                    <img src="/camp2.jpg" alt="Facebook Ads Campaign Screenshot" className="h-full object-cover rounded-xl shadow-lg border border-gray-200 w-full" />
                </div>
            </div>
        </div>
    </section>
